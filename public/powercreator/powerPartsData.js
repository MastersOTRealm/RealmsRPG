const powerPartsData = [
    {
        ...
        description: "+25% Increase the attack roll or potency of this power by +1.",
        baseTP: 2,
        baseEnergy: 0.25,
        opt1Cost: 0.25,
        opt1Description: "+25% EN for each additional +1, up to a maximum increase of +5.",
        TPIncreaseOpt1: 0,
        type: "Base",
        category: "General"
    },
    ...
    {
        name: "Find Path",
        description: "2 TP, 20 EN: Name a specific location you are familiar with. You gain an awareness of the most direct physical route to reach it. For the duration, while you remain in the same realm as the location, you intuitively sense its distance and direction. When presented with multiple paths, you know which one is the most direct route toward your destination. This power fails if the destination is in a different realm, is mobile (such as a floating fortress), or is too vague (like 'a dragon’s lair').",
        baseTP: 4,
        baseEnergy: 20,
        type: "base",
        category: "Detection"
    ...
    },
    {
        ...
        description: "2 TP, 4 EN: Cause a corpse to answer one question it might have answered in life, with no obligation to speak honestly. The answers may be cryptic or repetitive. Once five questions have been asked, or after 10 minutes, the corpse returns to its inanimate state.",
        baseTP: 4,
        baseEnergy: 4,
        opt1Cost: 2,
    ...
    {
        name: "Power Summon",
        description: "Create or Summon a Temporary Creature: You summon a creature that lasts for 5 minutes at a base cost of 6 EN + 1 TP per 1/4th level of the summon. You must decide the level and creature summoned when creating this power.",
        baseTP: 1,
        baseEnergy: 0,
        opt1Cost: 6,
        opt1Description: "1 TP, 6 EN per 1/4th level of the summon",
        TPIncreaseOpt1: 2,
        opt2Cost: 1.5,
    ...
    },
    {
        ...
        baseEnergy: 0,
        opt1Cost: 4,
        opt1Description: "1 TP, 4 EN: per 1/4th level of the summon.",
        TPIncreaseOpt1: 2,
        type: "base",
        category: "Summoning"
    },
    {
        ...
        baseEnergy: 0,
        opt1Cost: 9,
        opt1Description: "1 TP, 9 EN: per level of the creature.",
        TPIncreaseOpt1: 2,
        type: "base",
        category: "Summoning"
    },
    ...
    {
        name: "Resurrection",
        description: "4 TP, 75 EN: While in range of part of a dead target and return it to life with maximum Hit Points and any missing body parts restored, as long as the target died within the last ten years. This power part takes 1 hour to use.",
        baseTP: 22,
        baseEnergy: 75,
        opt1Cost: 15,
    ...
    },
    {
        ...
        description: "5 TP, 165 EN: Speak the name of a dead target and return it to life with maximum Hit Points and any missing body parts restored within the range of this power, as long as the target died within the last one-hundred years. This power part takes 1 hour to use.",
        baseTP: 25,
        baseEnergy: 165,
        opt1Cost: 40,
    ...
    },
    {
        ...
        baseEnergy: 6,
        opt1Cost: 6,
        opt1Description: "+1 TP, +6 EN for each additional feat, up to a maximum of 3 feats gained from this part.",
        TPIncreaseOpt1: 2,
        type: "base",
        category: "Adaptation"
    },
    ...
    },
    {
        ...
        baseEnergy: 5,
        opt1Cost: 1,
        opt1Description: "+1 EN & 1 TP for each additional space the illusion affects.",
        TPIncreaseOpt1: 1,
        opt2Cost: 1,
        opt2Description: "+1 EN & 2 TP to add sound to the illusion.",
        TPIncreaseOpt2: 2,
        opt3Cost: 2,
        opt3Description: "+2 EN & 2 TP to add both sound and animation/in-place movement.",
        TPIncreaseOpt2: 2,
        type: "base",
        category: "Illusion"
    },
    {
        ...
        TPIncreaseOpt1: 1,
        opt2Cost: 1,
        opt2Description: "+1 EN & 1 TP to add sound to the illusion.",
        TPIncreaseOpt2: 2,
        opt3Cost: 2,
        opt3Description: "+2 EN & 1 TP to add both sound and animation/in-place movement.",
        TPIncreaseOpt2: 2,
        type: "base",
        category: "Illusion"
    },
    ...
    },
    {
        ...
        baseEnergy: 9,
        opt1Cost: 4,
        opt1Description: "+4 EN & 1 TP to know their deeper thoughts and plans.",
        TPIncreaseOpt1: 2,
        opt2Cost: 8,
        opt2Description: "+8 EN & 2 TP instead to also know their deepest thoughts, secrets, intents, and desires.",
        TPIncreaseOpt2: 4,
        opt3Cost: 4,
    ...
    },
    {
        ...
        description: "0TP, 4 EN: Your illusion power is programed to move, sound, and appear in a certain way for up to 5 minutes when used.",
        baseTP: 1,
        baseEnergy: 4,
        type: "base",
        category: "Illusion"
    ...
    {
        name: "Dream",
        description: "2 TP, 22 EN: You choose a creature you are familiar with in the same realm. You or a willing creature enters a trance state to serve as a dream messenger. While in this trance, the messenger becomes unconscious and it's movment speed becomes 0. If the target is asleep, the messenger manifests in the target's dreams, allowing for conversation for the duration of the power as long as the target remains asleep. The messenger can also shape the dream environment, creating landscapes, objects, and various images. The messenger can exit the trance at any moment, which ends the power. The target will recall the dream in detail upon waking. If the target is awake when the power is used, the messenger becomes aware of this and can either terminate the trance (and thus the power) or wait for the target to fall asleep, at which point the messenger enters the target's dreams. You can choose to make the messenger appear terrifying to the target. If you do, the messenger can deliver a message of no more than ten words targeting resolve using your power bonus. On a failed save, the target suffers no restorative benefits from its recovery and takes 1d6 psychic damage upon waking.",
        baseTP: 4,
        baseEnergy: 22,
        opt1Cost: 2.5,
    ...
    },
    {
        ...
        baseEnergy: 8,
        opt1Cost: 11,
        opt1Description: "+11 EN & +1 TP for each extra AP, up to a maximum of 3 AP in total.",
        TPIncreaseOpt1: 2,
        type: "base",
        category: "Charm"
    },
    ...
    },
    {
        ...
        TPIncreaseOpt1: 1,
        opt2Cost: 2.5,
        opt2Description: "+2.5 to force the creature to spend these action point(s) (if any) as a reaction, moving immidiately instead. If the creature doesn't have action points to spend on reactionary movement, they must spend as many as they can now, then spend the rest as a reaction when they regain action points.",
        TPIncreaseOpt2: 2,
        type: "base",
        category: "Charm"
    },
    ...
    {
        name: "Friends",
        description: "2 TP, 6 EN: Target considers you friendly if it was indifferent or warm to you before and not hostile. If the target overcomes this power they are aware that you used a power to try and influence them provided their intelligence is above -4. Target's Resolve.",
        baseTP: 4,
        baseEnergy: 6,
        type: "base",
        category: "Charm"
    ...
    },
    {
        ...
        baseEnergy: 5,
        opt1Cost: 4,
        opt1Description: " +4 EN, +1 TP for each increase of 1 damage reduction, to a maximum of 10 including armor already worn. ",
        TPIncreaseOpt1: 2,
        opt2Cost: 4,
        opt2Description: " +4 EN, +1 TP for each additional 4 hours of duration.",
        TPIncreaseOpt2: 2,
        type: "base",
        category: "Defense"
    },
    ...
    },
    {
        ...
        baseEnergy: 4,
        opt1Cost: 4,
        opt1Description: "+4 EN, +1 TP for each additional damage type resistance. ",
        TPIncreaseOpt1: 2,
        type: "base",
        category: "Defense"
    },
    ...
    },
    {
        ...
        baseEnergy: 6,
        opt1Cost: 4,
        opt1Description: "+4 EN & 1 TP for each additional condition. ",
        TPIncreaseOpt1: 2,
        type: "base",
        category: "Defense"
    },
    {
        ...
        baseEnergy: 7,
        opt1Cost: 7,
        opt1Description: "+7 EN & 1 TP: Target's 1 unwilling creature and 1 willing creature. Whenever the willing creature would take damage it takes half of that damage and the unwilling creature take's the other half (after applying the willing target's resistances and damage reduction[s]).",
        TPIncreaseOpt1: 2,
        type: "base",
        category: "Defense"
    },
    ...
    },
    {
        ...
        description: "1.5 EN: Add one physical damage type to your power (Piercing, Slashing, or Blunt). This adds +1 of that type to the power's damage. +1.5 EN for each additional 1 damage of this type dealt. +2 EN, +1 TP to apply more than one of these damage types to the power (this cost does not increase the damage). Targets evasion.",
        baseTP: 2,
        baseEnergy: 1.5,
        opt1Cost: 1.5,
        ...
        TPIncreaseOpt1: 1,
        opt2Cost: 2,
        opt2Description: "+2 EN, +1 TP to apply more than one of these damage types to the power (this cost does not increase the damage).",
        TPIncreaseOpt2: 2,
        type: "base",
        category: "Offense"
    },
    {
        ...
        description: "1.5 EN: Add +1 elemental damage type to your power (Fire, Ice, Lightning, or Acid). This automatically adds +1 to the power's damage. +1.5 EN for each additional 1 damage of this type dealt. +2 EN, +1 TP to apply more than one element to the power (this cost does not increase the damage). Targets evasion.",
        baseTP: 2,
        baseEnergy: 1.5,
        opt1Cost: 1.5,
        opt1Description: "+1.5 EN for each additional 1 damage of this type.",
        TPIncreaseOpt1: 1,
        opt2Cost: 2,
        opt2Description: "+2 EN, +1 TP to apply more than one element to the power (this cost does not increase the damage).",
        TPIncreaseOpt2: 2,
        type: "base",
        category: "Offense"
    },
    ...
    },
    {
        ...
        baseEnergy: 4,
        opt1Cost: 1,
        opt1Description: "+1 EN and +1 TP to increase the maximum regained by +2.",
        TPIncreaseOpt1: 2,
        type: "base",
        category: "Offense"
    },
    ...
    },
    {
        ...
        description: "0.5 TP, 1 EN: You generate a breeze strong enough to ripple fabric, stir dust, rustle leaves, and close open doors and shutters, all within a one-space cube. Doors and shutters that are held open by a person or object remain unaffected.",
        baseTP: 1,
        baseEnergy: 1,
        type: "base",
        category: "Creation"
    },
    {
        ...
        description: "0.5 TP, 1 EN: You create a thin layer of dust or sand that spreads over surfaces in a one and a half meter square area, or you inscribe a single word in your handwriting in a patch of dirt or sand.",
        baseTP: 1,
        baseEnergy: 1,
        type: "base",
        category: "Creation"
    },
    {
        ...
        description: "0.5 TP, 1 EN: You conjure a spray of cool mist that lightly dampens creatures and objects within a meter and a half cube. Alternatively, you create one cup of clean water, either in an open container or on a surface, which evaporates after 1 minute.",
        baseTP: 1,
        baseEnergy: 1,
        type: "base",
        category: "Creation"
    },
    {
        ...
        description: "0.5 TP, 1 EN: You produce a thin cloud of harmless embers and colored, scented smoke within a one space cube. You determine the color and scent, and the embers can ignite candles, torches, or lamps in the area. The smoke's fragrance lingers for 1 minute.",
        baseTP: 1,
        baseEnergy: 1,
        type: "base",
        category: "Creation"
    },
    {
        ...
        description: "0.5 TP, 2 EN: You shape dirt, sand, fire, smoke, mist, or water that can fit within a 30-centimeter cube into a crude form (such as that of a creature), which holds its shape for 1 hour.",
        baseTP: 1,
        baseEnergy: 2,
        type: "base",
        category: "Creation"
    ...
    {
        name: "Tremors",
        description: "0.5 TP, 1 EN: The ground vibrates harmlessly in a rhythm or continuously, as you choose, within the entire range of the power for one minute.",
        baseTP: 1,
        baseEnergy: 1,
        type: "base",
        category: "Creation"
    },
    {
        ...
        description: "0.5 TP, 2 EN: You instantly cause an unsecured door or window to burst open or slam shut or another harmless effect breifly manipulating a movable unsecured object.",
        baseTP: 1,
        baseEnergy: 2,
        type: "base",
        category: "Creation"
    ...
    {
        name: "Detached Sound",
        description: "0.5 TP, 2 EN: Create a sound that is loaclized at a point within range such as ominous voices, a birds crow, or the distant sound of thunder.",
        baseTP: 1,
        baseEnergy: 2,
        type: "base",
        category: "Creation"
    ...
    {
        name: "Booming Voice",
        description: "0.5 TP, 1 EN: Your voice amplifies to up to three times its normal volume for 1 minute. During this time, you gain +1 on Intimidation skill rolls using Charisma.",
        baseTP: 2,
        baseEnergy: 1,
        opt1Cost: 1,
    ...
    {
        name: "Altered Eyes",
        description: "0.5 TP, 1 EN: Alter the color or appearance of your eyes for 1 minute.",
        baseTP: 1,
        baseEnergy: 1,
        type: "base",
        category: "Creation"
    ...
    {
        name: "Flavor",
        description: "0.5 TP, 1 EN: Give a normal or somehwat unique flavor to up to one cubic half meter of food or liquid.",
        baseTP: 1,
        baseEnergy: 1,
        type: "base",
        category: "Creation"
    },
    {
        ...
        description: "0.5 TP, 1.5 EN: You instantly ignite or extinguish a small flamable object such as a candle, torch, or small campfire.",
        baseTP: 1,
        baseEnergy: 1.5,
        type: "base",
        category: "Creation"
    },
    {
        ...
        description: "0.5 TP, 1.5 EN: Slightly manipulate a plant by causing it to bud, bloom, grow a centimeter, wither slightly, change folower color to a different flower color or change leaf color to match a different season and so on.",
        baseTP: 1,
        baseEnergy: 1.5,
        type: "base",
        category: "Creation"
    ...
    {
        name: "Chill or Warm",
        description: "0.5 TP, 1 EN: Warm or chill up to one cubic half meter of material, food or liquid.",
        baseTP: 1,
        baseEnergy: 1,
        type: "base",
        category: "Creation"
    ...
    {
        name: "Mark",
        description: "0.5 TP, 1.5 EN: You cause a color, a small mark, or a symbol to manifest on an object or surface taking up no more than half a square meter for a duration of 1 hour.",
        baseTP: 1,
        baseEnergy: 1.5,
        type: "base",
        category: "Creation"
    ...
    {
        name: "Clean or Soil",
        description: "0.5 TP, 1 EN: Instantly clean or soil an area no larger than half a cubic meter.",
        baseTP: 1,
        baseEnergy: 1,
        type: "base",
        category: "Creation"
    ...
    {
        name: "Sensory Effect",
        description: "0.5 TP, 1.5 EN: Create a harmless sensory effect, such as cascading leaves, ethereal dancing fairies, a soft breeze, the sound of an animal, or a faint scent, soft musical notes or another noise. The effect must fit within a 1 space cube.",
        baseTP: 1,
        baseEnergy: 1.5,
        type: "base",
        category: "Creation"
    ...
    {
        name: "Tiny Creation",
        description: "0.5 TP, 1.5 EN: You conjure a nonmagical trinket or an illusory image that can fit in your hand. It remains until the end of your next turn. A trinket cannot deal damage and has no monetary value. It lasts 1 minute.",
        baseTP: 1,
        baseEnergy: 1.5,
        type: "base",
        category: "Creation"
    ...
    {
        name: "Contact Divine",
        description: "2 TP, 15 EN: Contact a divine being, it's servants, or another powerful and knowledgable being who is reveared. The being must truthfully answer one question to the best of it's knowledge about events that will transpire in the next 7 days and things relating to those events. You must wait to use the power again until you've finished a full recovery or when you use it again you have a 25% chance of failure (roll D100, 25 and under being failure). Each time you use this power this way the chance of failure increases by 25%.",
        baseTP: 4,
        baseEnergy: 15,
        type: "base",
        category: "Utility"
    },
    {
        ...
        description: "2 TP, 17 EN: Contact a divine being, it's servants, or another powerful and knowledgable being who is reveared. The being must truthfully answer one question to the best of it's knowledge using yes or no or a short answer if that isn't clear. You must wait to use the power again until you've finished a full recovery or when you use it again you have a 25% chance of failure (roll D100, 25 and under being failure). Each time you use this power this way the chance of failure increases by 25%.",
        baseTP: 4,
        baseEnergy: 17,
        opt1Cost: 4,
    ...
    },
    {
        ...
        description: "2 TP, 15 EN: You commune with the natural world around you gathering information from plants and animals which grant you knowledge about the surrounding 100 meters of landscape, including bodies of water, settlements, ruins, common wildlife, uncommon creatures in the area, and so on.",
        baseTP: 4,
        baseEnergy: 15,
        opt1Cost: 2.5,
    ...
    },
    {
        ...
        description: "2 TP, 20 EN: You contact a knowledgable entity from another realm. The being must truthfully answer one question to the best of it's knowledge using yes or no or a short answer if that isn't clear. You must wait to use the power again until you've finished a full recovery or when you use it again you have a 25% chance of failure (roll D100, 25 and under being failure). Each time you use this power this way the chance of failure increases by 25%.",
        baseTP: 4,
        baseEnergy: 20,
        opt1Cost: 2,
    ...
    {
        name: "True Telepathy",
        description: "2 TP, 30 EN: You link your mind with a willing creature with which you are familar with who is on the same realm as you. You and the target can share between eachother words, images, sensory information, and so on without any action cost. The power ends if you aren't in the same realm. Lasts 24 hours.",
        baseTP: 4,
        baseEnergy: 30,
        type: "base",
        category: "Utility"
    ...
    {
        name: "Foresight",
        description: "4 TP, 48 EN: Target gains +2 on all attempts to overcome actively or passively until the next Partial Recovery.",
        baseTP: 22,
        baseEnergy: 48,
        type: "base",
        category: "Utility"
    ...
    {
        name: "Noisy",
        description: "0 TP, -0.5 EN: This power can be heard from anywhere within 30 meters.",
        baseTP: 1,
        baseEnergy: -0.5,
        opt1Cost: -1,
    ...
    {
        name: "Exclude Area",
        description: "0 TP, 5 EN: You may choose to exclude certain parts within an area of effect of this power from being affected.",
        baseTP: 0,
        baseEnergy: 5,
        type: "base",
    ...
    {
        name: "Major Heal",
        description: "3 TP, 22 EN: Heal target for 25 Hit Points.",
        baseTP: 9,
        baseEnergy: 22,
        opt1Cost: 5,
    ...
    {
        name: "Massive Heal",
        description: "4 TP, 37 EN: Target heals for 80 hit points. +5 EN for each additional 15 hit points.",
        baseTP: 22,
        baseEnergy: 37,
        opt1Cost: 5,
    ...
    {
        name: "Stablize",
        description: "2 TP, 9 EN: Target creature that is in the dying condition returns to 0 hit points and is stabilized, though still in the dying condition.",
        baseTP: 4,
        baseEnergy: 9,
        type: "base",
        category: "Adaptation"
    ...
    {
        name: "Regenerate",
        description: "2 TP, 42 EN: Target creature's chosen body part regenerates over the next 24 hour period. During this time it cannot be used. If the creature dies before the bodypart has regenerated this power ends leaving the limb partially regenerated, unless the target is already dead.",
        baseTP: 4,
        baseEnergy: 42,
        type: "base",
        category: "Adaptation"
    ...
    {
        name: "Revive",
        description: "2 TP, 15 EN: Restore a dead target to 1 hit point, as long as it died within the last round and has all vital body parts. You must decide how many rounds when creating the power. Revived targets are at 0 HP and stable.",
        baseTP: 4,
        baseEnergy: 15,
        opt1Cost: 1.5,
    ...
    },
    {
        ...
        baseEnergy: 3,
        opt1Cost: 1.5,
        opt1Description: "+1.5 EN +1 TP for an additional 200 kgs of weight levitated.",
        TPIncreaseOpt1: 2,
        opt2Cost: 1.5,
        opt2Description: "+1.5 EN +1 TP per additional object levitated (weight ability to lift is split between all objects).",
        TPIncreaseOpt2: 2,
        type: "base",
        category: "Control"
    },
    {
        ...
        baseEnergy: 6,
        opt1Cost: 2.5,
        opt1Description: "+2.5 EN +1 TP for each additional round suspended.",
        TPIncreaseOpt1: 2,
        type: "base",
        category: "Control"
    },
    ...
    },
    {
        ...
        description: "2 TP, 7 EN: Remove 1 of the target's action points. At the end of the target's turn it regains 1 less action point. +7 EN For each additional action point removed to a maximum of 3. Target's your choice of defense (might by default).",
        baseTP: 4,
        baseEnergy: 7,
        opt1Cost: 7,
    ...
    {
        name: "Part Liquid",
        description: "0.5 TP, 3 EN: All liquid in an area is moved to the sides of the area and slowly fills in after this power ends.",
        baseTP: 1,
        baseEnergy: 3,
        type: "base",
        category: "Control"
    ...
    {
        name: "Realmshift",
        description: "4 TP, 52 EN: Transport target to a different realm known to you, or a random unknown realm of the RM's choice. Targets mental fortitude or evasion of target creature if it is unwilling.",
        baseTP: 22,
        baseEnergy: 52,
        type: "base",
        category: "World Manipulation"
    ...
    },
    {
        ...
        baseEnergy: 15,
        opt1Cost: 7,
        opt1Description: "+7 EN, +1 TP for each additional multiplier of increase (triple, quadruple, etc.)",
        TPIncreaseOpt1: 2,
        type: "base",
        category: "World Manipulation"
    },
    {
        ...
        baseEnergy: 9,
        opt1Cost: 6,
        opt1Description: "+6 EN, +1 TP to increase the range of the gravity center by 1 space.",
        TPIncreaseOpt1: 2,
        type: "base",
        category: "World Manipulation"
    },
    {
        name: "Freeze Time",
        description: "2 TP, 21 EN: Time stops. Time freezes for every target and object, except those your character is touching or carrying before freezing time. Using any powers or techniques or making any attacks while time is frozen that would harm another creature causes this power to end immediately, unfreezing time and resuming initiative order with the turn after yours.",
        baseTP: 4,
        baseEnergy: 21,
        opt1Cost: 11,
        opt1Description: "+11 EN, +1 TP per additional round of frozen time",
        TPIncreaseOpt1: 2,
        type: "base",
        category: "World Manipulation"
    },
    {
        name: "Rewind Time",
        description: "2 TP, 22 EN: Time reverses a target creature or object, placing them in the state they were in exactly one round before. They return to the original condition and position they were in at the beginning of the turn in which time was rewound. If the target is unwilling, you target their Evasion.",
        baseTP: 4,
        baseEnergy: 22,
        opt1Cost: 9,
        opt1Description: "+9 EN, +1 TP per additional round(s) of rewinded time.",
        TPIncreaseOpt1: 2,
        type: "base",
        category: "World Manipulation"
    },
    {
        ...
        TPIncreaseOpt1: 1,
        opt2Cost: 7,
        opt2Description: "+7 EN, +1 TP to add +1d2 damage per turn to the terrain landscape targeting Reflex, i.e., inside a volcanic terrain, creatures would roll Reflex at the start of their turn(s), taking 1d2 fire damage on failure.",
        TPIncreaseOpt2: 2,
        opt3Cost: 11,
        opt3Description: "+11 EN, +1 TP for every additional 5 minutes.",
        TPIncreaseOpt2: 2,
        type: "base",
        category: "World Manipulation"
    },
    {
        ...
        TPIncreaseOpt1: 1,
        opt2Cost: 2.5,
        opt2Description: "+2.5 EN, +1 TP to add 5 HP to the plant",
        TPIncreaseOpt2: 2,
        type: "base",
        category: "World Manipulation"
    },
    {
        ...
        description: "2 TP, 4 EN: Target plant in range holds the effects of the power. If the power is an attack power, the plant may use the power once per round at the beginning of the round, for as many rounds as the space(s) the plant occupies (if the plant occupies 3 spaces, it can cast the power 3 times total, once per round). The plant uses your power attack bonus and potency for attacks but has -4 to both. Lasts 1 minute.",
        baseTP: 4,
        baseEnergy: 4,
        opt1Cost: 3,
        opt1Description: "+3 EN, +1 TP per additional minute.",
        TPIncreaseOpt1: 2,
        type: "base",
        category: "World Manipulation"
    },
    ...
    },
    {
        ...
        baseEnergy: 0,
        opt1Cost: 0.75,
        opt1Description: "0.75 EN for each TP of the weapon's proficiency cost.",
        TPIncreaseOpt1: 0,
        type: "base",
        category: "General"
    },
    {
        ...
        baseEnergy: 1.5,
        opt1Cost: 1.5,
        opt1Description: "+1.5 EN, +1 TP to triple damage dealt to objects, walls, ceilings, etc. instead",
        TPIncreaseOpt1: 2,
        type: "base",
        category: "General"
    },
    {
        ...
        TPIncreaseOpt2: 0,
        opt3Cost: 0,
        opt3Description: "-0.5 TP Use this to only pay TP for the highest TP part by reducing cost of other parts.",
        TPIncreaseOpt3: -0.5,
        type: "base",
        category: "General"
    },
    ...
    },
    {
        ...
        description: "0 TP, 25% EN: When you hit a target with a weapon attack you may choose to spend action points and energy immidiately to use this power as part of that attack, automatically having it take effect on the target without requiring any overcome to do so",
        baseTP: 0,
        baseEnergy: 0.25,
        type: "increase",
        category: "General"
    },
    {
        ...
        description: "0 TP, 50% EN: When the target of this power overcome's it or dies before the duration of the power ends you may use a quick action or reaction to choose a new target for this power, targeting them as normal. The power must have a duration longer than 1 round. The overcome cannot be the initial overcome when the power was used, it must be a later overcome such as a target rolling a defense against your potency on it's turn.",
        baseTP: 0,
        baseEnergy: 0.5,
        type: "increase",
        category: "Power Mechanics"
      ...
      {
        name: "Wish",
        description: "4 TP: Reduce the cost of a power to 90 EN as long as it's total cost is under 200 EN. You gain 2 levels of exhaustion that cannot be recovered in any way other than the base exhaustion rules for each time you use this power (after the first time) each full recovery.",
        baseTP: 22,
        baseEnergy: 0,
        opt1Cost: -1,
      ...
      },
      {
        ...
        description: "0 TP, -25% EN: When a target overcomes any part of this power, that part of the power can no longer target them. Can only added to offensive powers",
        baseTP: 0,
        baseEnergy: -0.25,
        type: "decrease",
        category: "Power Mechanics"
      ...
      },
      {
        ...
        description: "0 TP, 2 EN: Reduce the multiple attack penalty of the affected creature by 1.",
        baseTP: 1,
        baseEnergy: 2,
        opt1Cost: 2,
      ...
      },
      {
        ...
        description: "0 TP, -X EN: If your power benefits yourself or an ally, you can add a negative effect for you or an ally to reduce the power's cost by an amount equal to 50% the energy cost of the negative part. The negative effect cannot be nullified by you or an ally.",
        baseTP: 0,
        baseEnergy: 0,
        opt1Cost: -1.5,
    ...
    {
        name: "Specialized",
        description: "0 TP, 12.5% EN: Part or all of the power causes either +1 on attack rolls or -1 on to Defense rolls based on criteria like creature type or species (choose one).",
        baseTP: 0,
        baseEnergy: 0.125,
        opt1Cost: 0.125,
    ...
    },
    {
        ...
        description: "0 TP, -25% EN: If the power meets these criteria, its cost is reduced by ¼: Lasts only 1 round. Only applies adaptation effects (other than Hit Point or Energy regain). Is not over 10 EN in cost.",
        baseTP: 0,
        baseEnergy: -0.25,
        type: "decrease",
        category: "Power Mechanics"
    },
    {
        ...
        description: "0 TP, -25% EN: Target may roll your choice of defense against your potency. On success, they are unaffected. If the target is an ally it must make this roll against your default potency (ie your potency without any bonuses or penalties).",
        baseTP: 0,
        baseEnergy: -0.25,
        type: "decrease",
        category: "Power Mechanics"
    },
    {
        ...
        description: "0 TP, -12.5% EN: You must remain within a certain range of the target of this power. If either target is ever beyond this range the power ends. The range is equal to one half of the range of this power. Must be added to power that targets another creature and has a duration longer than 1 round.",
        baseTP: 0,
        baseEnergy: -0.125,
        type: "decrease",
        category: "Power Mechanics"
    ...
    },
    {
        ...
        description: "0 TP, X EN: Separate this power into different parts that each take effect on a set round of the power's duration. Only pay the lingering cost and power energy cost of the most expensive round effect/part of this power. When creating a power using this part, only pay the TP cost for the round with the highest TP cost, not for each option.",
        baseTP: 0,
        baseEnergy: 0,
        opt1Cost: -0.25,
        ...
        TPIncreaseOpt1: 0,
        opt1Cost: 0,
        opt1Description: "-0.5 TP Use to adjust TP cost accordingly.",
        TPIncreaseOpt1: -0.5,
        type: "base",
        category: "Power Mechanics"
    },
